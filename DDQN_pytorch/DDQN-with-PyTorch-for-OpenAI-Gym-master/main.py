...
def main(gamma=0.99, lr=1e-3, min_episodes=20, eps=1, eps_decay=0.995, eps_min=0.01, update_step=10, batch_size=64, update_repeats=50,
         num_episodes=1000, seed=42, max_memory_size=50000, lr_gamma=0.9, lr_step=100, measure_step=100,
    ...
    for episode in range(num_episodes):
        ...
        if episode % measure_step == 0:
            ...
            print("eps: ", eps)
            #new line
            plot_array_episodes.append(episode)
            plot_array_rewards.append(performance[-1][1])
